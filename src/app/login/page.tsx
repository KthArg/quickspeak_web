...
const DarkModeLogIn: NextPage = () => {
  ...
  return (
    <div className="w-full min-h-screen relative bg-[#232323] overflow-hidden text-white font-cabin flex items-center justify-center p-4 sm:p-6">
      ...
      {/* Ícono opcional para volver */}
      <ArrowLeft className="absolute top-6 left-6 md:top-10 md:left-14 w-9 h-9 md:w-11 md:h-11 text-white cursor-pointer" />

      <form
        onSubmit={handleSubmit}
        noValidate
        className="relative z-10 w-full max-w-sm flex flex-col items-start gap-6"
      >
        {/* Encabezado */}
        ...
        {/* Botón de Log In y link de Sign Up */}
