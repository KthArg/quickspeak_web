...
const LanguageIcon = ({ lang, isAdded, onClick }: { lang: Language, isAdded: boolean, onClick: () => void }) => {
    ...
    return (
        <button 
            onClick={onClick} 
            disabled={isAdded}
            className={`flex flex-col items-center gap-2 text-center transition-all ${isAdded ? 'opacity-40 cursor-not-allowed' : 'hover:scale-105'}`}
        >
            ...
            >
                ...
                <div className="w-full flex flex-col items-center gap-3 text-center">
                    ...
                    className={`w-full rounded-full py-2.5 font-bold text-lg transition-colors
                        ${theme === 'dark' ? 'bg-cyan-400 text-black' : 'border-2 border-cyan-500 text-cyan-600 hover:bg-cyan-50'}`}
                    >
  ...
  return (
    <div className={`w-full min-h-screen relative font-cabin flex flex-col items-center p-6 md:p-10 transition-colors
        ...
        <header className="text-center mb-10 sm:mb-16">
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mt-10">Add a Language</h1>
        </header>
